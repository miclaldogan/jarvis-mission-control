...
def generate_missions(
    *,
    ...
    filler_tasks = [
        ...
        {
            "title": "Issue triage: 10dk hızlı bakış",
            "priority": "P3",
            "category": "work",
            "energy_cost": "low",
            "duration_minutes": 10,
            "tags": ["triage", "backlog"],
            "why": "Küçük triage, büyük birikmeyi önler.",
            "pack": "quality",
            "rule": "issue_triage",
        },
        {
            "title": "1 TODO'yu kapat (en küçük olan)",
            "priority": "P3",
            "category": "work",
            "energy_cost": "medium",
            "duration_minutes": 20,
            "tags": ["cleanup", "delivery"],
            "why": "Küçük tamamlamalar momentum sağlar.",
            "pack": "delivery",
            "rule": "close_small_todo",
        },
        {
            "title": "API hata kodlarını bir kez gözden geçir",
            "priority": "P3",
            "category": "work",
            "energy_cost": "low",
            "duration_minutes": 15,
            "tags": ["api", "errors"],
            "why": "Tutarlı error code'lar client tarafını kolaylaştırır.",
            "pack": "quality",
            "rule": "api_error_codes",
        },
        {
            "title": "1 endpoint için örnek response kaydet",
            "priority": "P3",
            "category": "admin",
            "energy_cost": "low",
            "duration_minutes": 10,
            "tags": ["docs", "examples"],
            "why": "Örnek response'lar entegrasyonu hızlandırır.",
            "pack": "maintenance",
            "rule": "save_example_response",
        },
        {
            "title": "Backend startup loglarını kontrol et",
            "priority": "P3",
            "category": "system",
            "energy_cost": "low",
            "duration_minutes": 5,
            "tags": ["ops", "startup"],
            "why": "Başlangıç uyarıları prod sorunlarını erken gösterir.",
            "pack": "ops",
            "rule": "startup_logs",
        },
        {
            "title": "1 dakika: nefes + postür düzelt",
            "priority": "P4",
            "category": "health",
            "energy_cost": "low",
            "duration_minutes": 2,
            "tags": ["health", "posture"],
            "why": "Kısa postür kontrolü boyun/sırt gerginliğini azaltır.",
            "pack": "routine",
            "rule": "posture_reset",
        },
        {
            "title": "Günlük notlar: 3 satır özet",
            "priority": "P4",
            "category": "admin",
            "energy_cost": "low",
            "duration_minutes": 5,
            "tags": ["notes", "routine"],
            "why": "Kısa özetler bağlam değişimini kolaylaştırır.",
            "pack": "routine",
            "rule": "daily_summary",
        },
        {
            "title": "Cache header'larını (X-Cache) kontrol et",
            "priority": "P2",
            "category": "system",
            "energy_cost": "low",
            "duration_minutes": 10,
            "tags": ["cache", "headers"],
            "why": "Header'lar debug sırasında tek bakışta bilgi verir.",
            "pack": "demo",
            "rule": "cache_headers_check",
        },
        {
            "title": "1 sayfalık kısa demo script'i güncelle",
            "priority": "P3",
            "category": "admin",
            "energy_cost": "low",
            "duration_minutes": 15,
            "tags": ["demo", "docs"],
            "why": "Kısa script, canlı demoda akışı korur.",
            "pack": "demo",
            "rule": "demo_script_update",
        },
        {
            "title": "UI'da loading state'leri kontrol et",
            "priority": "P3",
            "category": "work",
            "energy_cost": "low",
            "duration_minutes": 15,
            "tags": ["ui", "loading"],
            "why": "Doğru loading state kullanıcı deneyimini iyileştirir.",
            "pack": "quality",
            "rule": "loading_states",
        },
        {
            "title": "Bir ekranda empty state metnini iyileştir",
            "priority": "P4",
            "category": "work",
            "energy_cost": "low",
            "duration_minutes": 10,
            "tags": ["ui", "copy"],
            "why": "Empty state'ler kullanıcıyı yönlendirir.",
            "pack": "quality",
            "rule": "empty_state_copy",
        },
        {
            "title": "1 config değerini dokümante et",
            "priority": "P4",
            "category": "admin",
            "energy_cost": "low",
            "duration_minutes": 10,
            "tags": ["docs", "config"],
            "why": "Konfigürasyon net olursa kurulum kolaylaşır.",
            "pack": "maintenance",
            "rule": "doc_one_config",
        },
        {
            "title": "DB schema dokümanını hızlı kontrol et",
            "priority": "P3",
            "category": "study",
            "energy_cost": "low",
            "duration_minutes": 10,
            "tags": ["db", "schema"],
            "why": "Şema/doküman uyumsuzluğu sürpriz bug çıkarır.",
            "pack": "maintenance",
            "rule": "db_schema_review",
        },
        {
            "title": "Bir migration ihtiyacını not al",
            "priority": "P4",
            "category": "admin",
            "energy_cost": "low",
            "duration_minutes": 5,
            "tags": ["db", "planning"],
            "why": "İhtiyaçları erken not almak teknik borcu yönetir.",
            "pack": "maintenance",
            "rule": "migration_note",
        },
        {
            "title": "Endpoint latency için 1 örnek ölçüm al",
            "priority": "P3",
            "category": "system",
            "energy_cost": "low",
            "duration_minutes": 10,
            "tags": ["performance", "metrics"],
            "why": "Basit ölçümler bottleneck'leri gösterir.",
            "pack": "ops",
            "rule": "latency_sample",
        },
        {
            "title": "1 küçük güvenlik kontrolü: secret var mı tarama",
            "priority": "P2",
            "category": "system",
            "energy_cost": "medium",
            "duration_minutes": 15,
            "tags": ["security", "secrets"],
            "why": "Yanlışlıkla commit edilen secret büyük risk taşır.",
            "pack": "security",
            "rule": "secret_scan",
        },
        {
            "title": "Dependency lockfile değişimlerini gözden geçir",
            "priority": "P3",
            "category": "work",
            "energy_cost": "low",
            "duration_minutes": 15,
            "tags": ["deps", "review"],
            "why": "Lockfile değişimleri beklenmedik sürümleri getirebilir.",
            "pack": "maintenance",
            "rule": "lockfile_review",
        },
        {
            "title": "CI pipeline durumunu kontrol et",
            "priority": "P3",
            "category": "work",
            "energy_cost": "low",
            "duration_minutes": 5,
            "tags": ["ci", "ops"],
            "why": "CI kırıkları erken görünürse düzeltmek kolaylaşır.",
            "pack": "ops",
            "rule": "ci_status",
        },
        {
            "title": "Bir script/komutu README'ye ekle",
            "priority": "P4",
            "category": "admin",
            "energy_cost": "low",
            "duration_minutes": 10,
            "tags": ["docs", "scripts"],
            "why": "Script örnekleri kullanımı hızlandırır.",
            "pack": "maintenance",
            "rule": "doc_one_script",
        },
        {
            "title": "Frontend lint çalıştır (eslint)",
            "priority": "P3",
            "category": "work",
            "energy_cost": "medium",
            "duration_minutes": 15,
            "tags": ["frontend", "lint"],
            "why": "Lint uyarıları kaliteyi artırır.",
            "pack": "quality",
            "rule": "frontend_lint",
        },
        {
            "title": "Backend type check notlarını gözden geçir",
            "priority": "P4",
            "category": "study",
            "energy_cost": "low",
            "duration_minutes": 10,
            "tags": ["typing", "python"],
            "why": "Küçük type uyarıları gelecekte bug'u azaltır.",
            "pack": "quality",
            "rule": "type_notes",
        },
        {
            "title": "Cache MISS/HIT senaryosunu 1 kez not al",
            "priority": "P4",
            "category": "study",
            "energy_cost": "low",
            "duration_minutes": 5,
            "tags": ["cache", "learning"],
            "why": "Demo sırasında hızlı açıklama için faydalı.",
            "pack": "demo",
            "rule": "cache_story",
        },
        {
            "title": "1 grafik/metric label tutarlılığını kontrol et",
            "priority": "P4",
            "category": "work",
            "energy_cost": "low",
            "duration_minutes": 10,
            "tags": ["ui", "metrics"],
            "why": "Tutarlı etiketler okunabilirliği artırır.",
            "pack": "quality",
            "rule": "metric_labels",
        },
    ]
